        ...
        NavigationStack {
            ...
            .toolbar {
                ToolbarItem(placement: .confirmationAction) {
                    Button("Add") {
                        let g = Goal(title: title, description: description, deadline: GoalDeadline, subgoals: [], reflections: [], character: Character(profileImage: profileImage, image: image, waterLevel: 30, foodLevel: 30))
